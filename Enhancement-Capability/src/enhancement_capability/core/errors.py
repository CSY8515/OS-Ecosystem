...
class EnhancementCapabilityError(Exception):
    def __init__(self, code: ErrorCode, message: str) -> None:
        super().__init__(message)
        self.code = code

class ContextValidationError(EnhancementCapabilityError):
    def __init__(self, message: str) -> None:
        super().__init__(ErrorCode.INVALID_CONTEXT, message)

class InputValidationError(EnhancementCapabilityError):
    def __init__(self, message: str) -> None:
        super().__init__(ErrorCode.INPUT_VALIDATION_FAILED, message)

class OutputValidationError(EnhancementCapabilityError):
    def __init__(self, message: str) -> None:
