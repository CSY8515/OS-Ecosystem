...
Living OS와 Universal Learning Engine은 독립 소유권·데이터·배포를 유지합니다. AI Hub는 OS Ecosystem Repository와 Release·배포 수명주기를 공유합니다. Project Seed와 내부 Sapling은 공식 UI 형태이며 소유권 분류를 변경하지 않습니다. 설명 Metadata는 [6W Contract](../architecture/METADATA_CONTRACT.md)를 따릅니다.
