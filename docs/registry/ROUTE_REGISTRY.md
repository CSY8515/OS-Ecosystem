...
| --- | --- | --- | --- |
| OS Ecosystem Home | OS Ecosystem | `./` | current tab |
| OS Ecosystem Overview | OS Ecosystem, repository-owned | `?view=overview` | current tab |
| AI Hub | OS System, repository-owned | `?project=ai-hub` | current tab |
| Living OS | OS System, independent | public HTTPS URL | `target=_blank`, `rel=noopener noreferrer` |
| Universal Learning Engine | OS System, independent | public HTTPS URL | `target=_blank`, `rel=noopener noreferrer` |
| Capabilities | OS Ecosystem Core | `#capability` | current page |
| Governance | OS Ecosystem | `#governance` | current page |
...
Future projects receive no implementation in advance. They enter through an approved Project Registry record, 6W Metadata, Route, Status, Health, ownership, and version declaration.
