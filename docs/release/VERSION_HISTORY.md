...
## v0.6.1
Introduced the AI Hub launcher card and top navigation entry. Its ownership and release-boundary description was corrected by v0.6.2.
...
## v0.3.3
Added Enhancement Capability.

## v0.2.3
Added Governance, Architecture, and Registry UI.

## v0.2.2
Stabilized launcher HTML rendering.

## v0.2.1
Connected both project applications.
