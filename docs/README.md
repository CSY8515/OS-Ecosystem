...
2. Root and Capability READMEs are navigation entry points.
3. Internal links are relative and validated.
4. Moves require migration notes and link updates.
5. Documentation follows versioned review and release gates.
