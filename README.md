...
OS Ecosystem is the governance, architecture, registry, capability, navigation, and shared-platform repository for the ecosystem.

**Current version:** v0.6.2
**Release type:** Integrated AI Platform Patch
**Status:** Stable
...
- OS ECOSYSTEM remains the visual center, with official projects and shared platforms presented as surrounding nodes.
...
- Living OS and Universal Learning Engine retain their project boundaries. AI Hub is a repository-owned common platform component released with OS Ecosystem.
...
- [Release](./docs/release/RELEASE_NOTES_v0.6.2.md): release notes, version history, and migration notes
...
- AI-Hub contains the integrated common AI platform source, adapters, tests, configuration examples, runtime-data boundary, and authoritative component design set.
