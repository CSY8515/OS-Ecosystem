"""OS Ecosystem v0.72 interactive world UI."""
...
def apply_theme() -> None:
    ...
    .project-seed-field{position:absolute;z-index:6;inset:0}.project-seed{--seed-accent:#d7bb78;position:absolute;display:flex;align-items:flex-end;justify-content:center;box-sizing:border-box;border:1px solid rgba(239,231,207,.08);border-radius:49% 49% 20% 20%/61% 61% 18% 18%;color:var(--paper)!important;text-decoration:none!important;isolation:isolate;cursor:pointer;will-change:transform;transition:transform .17s cubic-bezier(.22,.61,.36,1),border-color .17s ease,box-shadow .17s ease}.project-seed:after{content:"";position:absolute;z-index:1;inset:1px;border:1px solid rgba(239,231,207,.18);border-radius:inherit;background:transparent;pointer-events:none;transition:border-color .17s ease,background .17s ease}.project-seed:focus-visible{outline:2px solid #f3f0e6!important;outline-offset:4px;transform:translateY(-3px) scale(1.004);border-color:color-mix(in srgb,var(--seed-accent) 70%,#f8f3e4);box-shadow:0 10px 22px rgba(0,0,0,.2)!important}.project-seed:focus-visible:after{border-color:color-mix(in srgb,var(--seed-accent) 76%,#f8f3e4);background:color-mix(in srgb,var(--seed-accent) 7%,transparent)}.project-seed .mobile-seed-art{z-index:0;display:none}
    @media(hover:hover) and (pointer:fine){.project-seed:hover{transform:translateY(-3px) scale(1.004);border-color:color-mix(in srgb,var(--seed-accent) 64%,#f8f3e4);box-shadow:0 10px 22px rgba(0,0,0,.2)}.project-seed:hover:after{border-color:color-mix(in srgb,var(--seed-accent) 76%,#f8f3e4);background:color-mix(in srgb,var(--seed-accent) 7%,transparent)}.project-seed:hover .project-seed-label{border-color:color-mix(in srgb,var(--seed-accent) 88%,#f8f3e4);background:rgba(2,8,12,.5)}.project-seed:hover .project-seed-label strong{color:#fff}.project-seed:hover .project-seed-label em{color:#f0f3ef}.project-seed:hover .project-seed-label b{border-color:color-mix(in srgb,var(--seed-accent) 82%,#fff);background:color-mix(in srgb,var(--seed-accent) 14%,transparent);transform:translateX(1px)}}.project-seed:focus-visible .project-seed-label{border-color:color-mix(in srgb,var(--seed-accent) 88%,#f8f3e4);background:rgba(2,8,12,.5)}.project-seed:focus-visible .project-seed-label strong{color:#fff}.project-seed:focus-visible .project-seed-label em{color:#f0f3ef}.project-seed:focus-visible .project-seed-label b{border-color:color-mix(in srgb,var(--seed-accent) 82%,#fff);background:color-mix(in srgb,var(--seed-accent) 14%,transparent);transform:translateX(1px)}.project-seed:active{transform:translateY(-1px) scale(.992);transition-duration:.07s}.project-seed:active:after{background:color-mix(in srgb,var(--seed-accent) 4%,transparent)}.project-seed:active .project-seed-label b{transform:scale(.92)}
    .project-seed-label{position:absolute;z-index:2;left:50%;bottom:8%;display:grid;grid-template-columns:minmax(0,1fr) 24px;column-gap:10px;min-width:150px;min-height:44px;box-sizing:border-box;padding:7px 8px 8px;transform:translateX(-50%);border-bottom:1px solid color-mix(in srgb,var(--seed-accent) 76%,transparent);border-radius:6px 6px 0 0;background:rgba(2,8,12,.34);text-align:left;text-shadow:0 2px 6px #000;box-shadow:0 3px 10px rgba(0,0,0,.16);transition:background .17s ease,border-color .17s ease}.project-seed-label strong,.project-seed-label em,.project-seed-label b{display:block}.project-seed-label strong{grid-column:1;margin:0;color:#edf0eb;font-size:clamp(13px,1.1vw,18px);font-weight:600;line-height:1.15;letter-spacing:.005em;white-space:nowrap;transition:color .17s ease}.project-seed-label em{grid-column:1;margin-top:3px;color:#cbd4cf;font-size:clamp(7px,.58vw,10px);font-style:normal;line-height:1.35;transition:color .17s ease}.project-seed-label b{grid-column:2;grid-row:1/3;display:grid;width:22px;height:22px;align-self:center;place-items:center;border:1px solid color-mix(in srgb,var(--seed-accent) 80%,transparent);border-radius:50%;color:#f5f7f3;font-size:11px;font-weight:600;transition:transform .15s ease,border-color .15s ease,background .15s ease}.project-seed.node-living{left:16.7%;top:26%;width:17%;height:61%;--seed-accent:#b8d27e}.project-seed.node-learning{left:68.1%;top:26%;width:17%;height:61%;--seed-accent:#91c4e5}.project-seed.node-ai{left:44.1%;top:58%;width:14.3%;height:41%;--seed-accent:#d8b66d}.project-seed.node-learning .project-seed-label{min-width:215px}.project-seed.node-ai .project-seed-label{bottom:6%}.is-unavailable.project-seed{opacity:.55;cursor:not-allowed;pointer-events:none}
